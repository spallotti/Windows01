...
// Windows01.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CWindows01App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CWindows01App

CWindows01App::CWindows01App()
{
...
// El único objeto CWindows01App

CWindows01App theApp;


// Inicialización de CWindows01App

BOOL CWindows01App::InitInstance()
{
